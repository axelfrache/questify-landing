        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-4">
              Questify is open-source. Follow along, suggest ideas, or contribute - we're building
              this together, one commit at a time.
            </p>

            <p className="text-sm text-muted-foreground/70">Built publicly on GitHub</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              size="lg"
              variant="outline"
              className="h-12 px-6 rounded-xl hover:bg-primary/10 hover:text-primary hover:border-primary/50 transition-all"
              asChild
            >
              <a
